import { getScoreboard } from '../services/espnService.js'; // Reutilizamos la función del scoreboard
...
export const fetchBarcelonaEvents = async (req, res) => {
    try {
        ...
        res.status(500).json({ message: "Error al procesar los partidos del Barcelona", error: error.message });
    }
};
