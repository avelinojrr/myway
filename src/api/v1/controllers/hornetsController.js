import { getScoreboard } from '../services/espnService.js'; // Reutilizamos la función que obtiene el scoreboard
...
export const fetchHornetsEvents = async (req, res) => {
    try {
        ...
        res.status(500).json({ message: "Error al procesar los partidos de los Hornets", error: error.message });
    }
};
