import { getScoreboard } from '../services/espnServiceNFL.js'; // Asumimos que ya tienes este servicio implementado
...
export const fetchChiefsEvents = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        message: 'Error al procesar los partidos de los Kansas City Chiefs',
        error: error.message,
      });
  }
};
