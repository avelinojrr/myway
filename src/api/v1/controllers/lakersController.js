import { getScoreboard } from '../services/espnServiceNBA.js'; // Reutilizamos la función que ya tenemos
...
export const fetchLakersEvents = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        message: 'Error al procesar los partidos de Los Angeles Lakers',
        error: error.message,
      });
  }
};
